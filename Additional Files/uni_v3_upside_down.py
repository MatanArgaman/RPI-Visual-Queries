...
#A version used when the camera is upside down
    ...
    with picamera.PiCamera() as camera:
        ...
        with picamera.array.PiRGBArray(camera) as stream:
            ...
            while True:
                ...
                if detectRight:
                    hands = handDetect(hand_cascade , gray ,detectLeft = False,  getNegSamples = False)
                    ...
                    if numLeftAttempts < MAX_NUM_LEFT_ATTMEPTS:
                        ...
                        lhands = handDetect(hand_cascade, gray, detectLeft = True, getNegSamples = False)
                        print lhands
                        ...
                        if lhValidator.checkForDetectionAndUpdateCounter():
                            ...
                            if HandDetection.validateLH_RelativeToRH(foundLHand, foundRHand):
                                ...
                                fullResIm= cv2.flip(fullResIm,0)
                                fullResIm = cv2.flip(fullResIm,1)
